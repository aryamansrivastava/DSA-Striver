...
// Brute Force Approach -> we will simply find InOrder of BST which is always sorted 
// and then for kth smallest -> Inorder[k-1] and for Kth Largest -> Inorder[arr.size()-k]
// TC -> O(h)
// SC -> O(N) for storing inorder in the vector
